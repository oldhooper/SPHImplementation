...
constexpr double GAS_CONST = 20000.0;        // тестировал с 12к, 80к, 200к на высоких значениях - замедление программы
constexpr double VISC = 3.0;         // уменьшил с 20 до 3
constexpr double MASS = 12000.0;        // расчитывается по формуле rest_density*spacing**2, для стабильности понизим 
